package com.med.discuss.ui.settings
...
import com.med.discuss.databinding.FragmentSettingsBinding
import com.med.discuss.data.EventObserver
import com.med.discuss.util.SharedPreferencesUtil
import com.med.discuss.util.convertFileToByteArray
...
class SettingsFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && requestCode == selectImageIntentRequestCode) {
            if (viewModel.userInfo.value?.profileImageUrl?.isEmpty() == true){
                data?.data?.let { uri ->
                ...
                throw IllegalArgumentException("image is Unknown")
            }
        }
    }
