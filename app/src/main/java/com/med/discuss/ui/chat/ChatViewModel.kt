package com.med.discuss.ui.chat

import androidx.lifecycle.*
import com.med.discuss.data.Result
import com.med.discuss.data.db.entity.Chat
import com.med.discuss.data.db.entity.Message
import com.med.discuss.data.db.entity.UserInfo
import com.med.discuss.data.db.remote.FirebaseReferenceChildObserver
import com.med.discuss.data.db.remote.FirebaseReferenceValueObserver
import com.med.discuss.data.db.repository.DatabaseRepository
import com.med.discuss.ui.DefaultViewModel
import com.med.discuss.util.addNewItem
...
class ChatViewModel(private val myUserID: String, private val otherUserID: String, private val chatID: String) : DefaultViewModel() {
    ...
    fun sendMessagePressed() {
        if (newMessageText.value?.isEmpty() == false) {
            if (newMessageText.value.isNullOrBlank()) {
                throw IllegalArgumentException("message is Unknown")
            }
